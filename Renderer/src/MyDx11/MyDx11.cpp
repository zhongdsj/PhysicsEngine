...
{
	return new ZDSJ::MyDx11(_hwnd, _window_width, _window_height, static_cast<ZDSJ::RenderType>(_render_type));
}
...
ZDSJ::MyDx11::MyDx11(HWND _hwnd, int _window_width, int _window_height, ZDSJ::RenderType _render_type)
{
	...
	// 
	this->m_drawable_manager = new ZDSJ::BaseManager(this->m_device, this->m_context);
