...
namespace ZDSJ {
	...
	public:
		...
		bool registerCommand(const std::string& _category, const std::string& _operation, const std::string& _description, HandlerFunc _handle_func);
	...
	private:
		...
		explicit Command(Context* _context);
		void exec(const std::string& _category, const std::string& _operation, const std::string& _data);
		void help();
